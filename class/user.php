...
class User{
	...
	public function searchByNickname($nickname = null){
		if($nickname){
			$field = 'nickname';
			$data = $this->_db->get('user', array($field, '=', $nickname));
	...
	public function searchPointforLeaderBoardWithCorporate($corporateID = null){
		if($corporateID){
			$field = (is_numeric($corporateID)) ? 'corporateID' : 'email';
			$data = $this->_db->getall3('user', array($field, '=', $corporateID), 'point_recog');
	...
	public function searchPointforLeaderBoardWithCompany($companyID = null){
		if($companyID){
			$field = (is_numeric($companyID)) ? 'companyID' : 'email';
			$data = $this->_db->getall3('user', array($field, '=', $companyID), 'point_recog');
	...
	// public function searchPointforLeaderBoard()
	// {
	// 	$data = $this->_db->getall3('user', 'point_recog');
	// 	if($data->count())
	// 	{
	// 		$this->_data = $data->results();
	// 		return $this->_data;
